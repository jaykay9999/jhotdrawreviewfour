...
public final class Geom {
   ...
   * bottom.
   *
   * <p>The new Rectangle2D.Double grows is if hozrintalExpansion and verticalExpansion are positive,
   *
   * <p>If negative values are supplied for hozrintalExpansion and verticalExpansion, the size of the Rectangle2D decreases
   * accordingly. The grow() method does not check whether the resulting values of width and height
   * are non-negative.
   *
   * @param hozrintalExpansion
   * @param verticalExpansion
   */
  public static void grow(Rectangle2D.Double r, double hozrintalExpansion, double verticalExpansion) {
    r.x -= hozrintalExpansion;
    r.y -= verticalExpansion;
    r.width += hozrintalExpansion * 2d;
